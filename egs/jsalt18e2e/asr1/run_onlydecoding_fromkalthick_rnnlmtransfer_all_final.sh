...
expdir=exp/${train_set}_${etype}_e${elayers}_subsample${subsample}_unit${eunits}_proj${eprojs}_d${dlayers}_unit${dunits}_${atype}_aconvc${aconv_chans}_aconvf${aconv_filts}_mtlalpha${mtlalpha}_${opt}_bs${batchsize}_mli${maxlen_in}_mlo${maxlen_out}_karthick_${hrs}hrs_transfer_rnnlmtransfer_added
if [ ${stage} -le 5 ]; then
    ...
    (
        ...
        lmexpdir=exp/train_rnnlm_2layer_bs256_transfer_${lang}
