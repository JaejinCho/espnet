...
lmexpdir=exp/train_rnnlm_2layer_bs256_transfer_${lm_lang}
lm_modeldir=/export/b15/jcho/espnet_JSALT2018/egs/jsalt18e2e/asr1/exp/train_rnnlm_2layer_bs256_shuffle
mkdir -p ${lmexpdir}
if [ ${stage} -le 3 ]; then
    echo "stage 3: LM Preparation"
    lmdatadir=data/local/lm_train_mono_${lm_lang}
#    mkdir -p ${lmdatadir}
#    sort -R data/tr_{babel_*,csj*,libri*}/text | text2token.py -s 1 -n 1 -l ${nlsyms} | \
