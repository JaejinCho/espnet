...
# config files
train_config=conf/train_pytorch_tacotron2+spkemb_spkidonly_nceloss_shufflebatching_bs128.yaml
...
expname=${expname}_spkloss_weight${spkloss_weight}_nceloss_weight${nceloss_weight}_unsync
