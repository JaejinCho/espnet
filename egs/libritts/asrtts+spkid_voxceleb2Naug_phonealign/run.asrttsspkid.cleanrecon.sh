...
# config files
train_config=conf/train_pytorch_forwardtacotron2+spkemb_2flstm512Nusecat_fullyunsync_shufflebatching_cleanrecon.yaml
...
expname=${expname}_spkloss_weight${spkloss_weight}_fullyunsync_cleanrecon # cleanrecon means reconstructing clean version of the input by TTS
