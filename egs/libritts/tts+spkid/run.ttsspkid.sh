...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    #awk '!($2 in a){a[$2]=0} {a[$2]+=1} END{for(i in a) print i, a[i]}' data/${train_set_ori}/utt2spk > data/${train_set_ori}/spk2num # when there is no spk2utt
    awk '{print $1" "NF-1}' data/${train_set_ori}/spk2utt > data/${train_set_ori}/spk2num
