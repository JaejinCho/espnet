...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    CUDA_VISIBLE_DEVICES=${gpu_ix} tts_train_speakerid_consistency.py \
           --model-module espnet.nets.pytorch_backend.e2e_tts_tacotron2_speakerid_consistency:Tacotron2 \
           --num-spk ${num_spk} \
