...
# /export/b18/jcho/espnet3/egs/libritts/asrtts+spkid_libris_txf_asr/run.asrttsspkid.spkloss_weight.new.sh
# Subsets are just a little different since empty transcription uttlist are a little different

# Copyright 2019 Nagoya University (Takenori Yoshimura)
#  Apache 2.0  (http://www.apache.org/licenses/LICENSE-2.0)

. ./path.sh || exit 1;
. ./cmd.mem10G.sh || exit 1;
...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
    ...
    cat /export/b11/jcho/kaldi_20190316/egs/librispeech/s5/data/train_clean_460_hires/text.11.0.0.tra.asr > data/train_clean_460/text
