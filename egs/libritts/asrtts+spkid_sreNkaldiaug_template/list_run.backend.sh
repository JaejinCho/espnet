...
(TODO: ING) bash local/extract_uttxvector_fromsegs_sre20_expanding.sh --nj 70 --model_path ${model_path} --eval_seg_NOdiscard true --eval_only true 2>&1 | tee log/extract_uttxvector_fromsegs_sre20.${embname}.NOdiscard_evalonly.log
