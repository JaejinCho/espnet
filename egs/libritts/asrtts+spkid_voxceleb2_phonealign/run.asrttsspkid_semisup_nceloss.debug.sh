...
# JJ: Edited from run.asrttsspkid_semisup_nceloss.sh for debugging
...
expname=${expname}_spkloss_weight${spkloss_weight}_fullyunsync_debug
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    echo "tr_json_nolab: ${tr_json_nolab}"
    ...
    CUDA_VISIBLE_DEVICES=${gpu_ix} tts_train_speakerid_nceloss_semi.py \
           --num-spk ${num_spk} \
