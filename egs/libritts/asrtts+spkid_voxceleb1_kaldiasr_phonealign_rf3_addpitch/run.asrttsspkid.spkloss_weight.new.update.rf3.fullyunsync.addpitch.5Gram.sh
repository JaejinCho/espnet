...
expname=${expname}_spkloss_weight${spkloss_weight}_fullyunsync_addpitch_5Gram
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    ${cuda_cmd_mem5G} --gpu ${ngpu} ${expdir}/train.log \
        tts_train_speakerid_addpitch.py \
           --model-module espnet.nets.pytorch_backend.e2e_tts_tacotron2_speakerid_update_fullyunsync_addpitch:Tacotron2 \
           --num-spk ${num_spk} \
