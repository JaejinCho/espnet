...
# Edited from run.asrttsspkid.spkloss_weight.new.update.rf1.forwardtacotron2.sh
...
# config files
train_config=conf/train_pytorch_forwardtacotron2+spkemb_noatt_rf1_2flstm512Nusecat_fullyunsync_shufflebatching_consloss.yaml
...
expname=${expname}_spkloss_weight${spkloss_weight}_consloss_weight${consloss_weight}_debug_stopaterror
