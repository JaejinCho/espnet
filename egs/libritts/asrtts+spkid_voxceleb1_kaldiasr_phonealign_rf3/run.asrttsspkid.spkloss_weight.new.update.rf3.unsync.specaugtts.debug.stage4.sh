...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    CUDA_VISIBLE_DEVICES=${gpu_ix} tts_train_speakerid_specaugtts.py \
           --model-module espnet.nets.pytorch_backend.e2e_tts_tacotron2_speakerid_update_unsync_specaugtts:Tacotron2 \
           --num-spk ${num_spk} \
