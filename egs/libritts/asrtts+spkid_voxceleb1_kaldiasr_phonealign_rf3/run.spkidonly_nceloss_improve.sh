...
# JJ Edited from run.spkidonly_nceloss.sh
# JJ: Edited from
...
expname=${expname}_speakeridonly_ttslossw${ttsloss_weight}_spkloss_weight${spkloss_weight}_final_nceloss_weight${nceloss_weight}_unsync200to400random
