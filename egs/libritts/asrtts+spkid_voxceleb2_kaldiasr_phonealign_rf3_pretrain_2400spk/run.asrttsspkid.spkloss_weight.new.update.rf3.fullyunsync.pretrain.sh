...
# train set
train_set=voxceleb2_2400spk # e.g) data/voxceleb2_{2400,1600,800}spk
...
if [ ! $num_spk -eq 2400 ];then
    echo "num speaker: ${num_spk} is supposed to be 2400." && exit 1
fi
echo The number of speakers for spkid training: ${num_spk} # should be 2400
