...
expname=${expname}_spkloss_weight${spkloss_weight}_unsync_chunklen${chunk_len}
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    ${cuda_cmd_mem20G} --gpu ${ngpu} ${expdir}/train.log \
        tts_train_speakerid.py \
           --model-module espnet.nets.pytorch_backend.e2e_tts_tacotron2_speakerid_update_unsync_${chunk_len}:Tacotron2 \
           --num-spk ${num_spk} \
