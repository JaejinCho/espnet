...
cuda_memsize=20 # this means 5. The other option is 20
...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
    ...
    #mv data/voxceleb_train/text data/voxceleb_train/.text && awk '{if(!(NF==1))print $0}' data/voxceleb_train/.text > data/voxceleb_train/text # JJ: This one does nothing in the kaldiali case
