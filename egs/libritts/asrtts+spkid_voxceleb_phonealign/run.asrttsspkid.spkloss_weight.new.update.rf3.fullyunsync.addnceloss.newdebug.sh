...
expname=${expname}_spkloss_weight${spkloss_weight}_nceloss_weight${nceloss_weight}_fullyunsync_newdebug
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    CUDA_VISIBLE_DEVICES=${gpu_ix} python -m ipdb /export/b18/jcho/espnet3/espnet/bin/tts_train_speakerid.py \
           --model-module espnet.nets.pytorch_backend.e2e_tts_tacotron2_speakerid_update_fullyunsync_nce:Tacotron2 \
           --num-spk ${num_spk} \
