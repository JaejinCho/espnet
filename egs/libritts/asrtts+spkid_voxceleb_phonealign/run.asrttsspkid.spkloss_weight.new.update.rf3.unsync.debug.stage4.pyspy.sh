...
expname=${expname}_spkloss_weight${spkloss_weight}_unsync_debug
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    CUDA_VISIBLE_DEVICES=${gpu_ix} py-spy record -o record_3600sec.svg -d 3600 -- tts_train_speakerid.py \
           --model-module espnet.nets.pytorch_backend.e2e_tts_tacotron2_speakerid_update_unsync:Tacotron2 \
           --num-spk ${num_spk} \
