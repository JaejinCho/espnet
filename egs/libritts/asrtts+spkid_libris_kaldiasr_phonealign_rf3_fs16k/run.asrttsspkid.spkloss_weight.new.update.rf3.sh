...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
    ...
    for subset in ${train_set} ${dev_set};do
        cp /export/b11/jcho/kaldi_20190316/egs/librispeech/s5/exp/chain_cleaned/tdnn_1d_sp/decode_train_clean_460_frame_subsampling_factor_3/phone.perframe.sym.txt data/${subset}/text # # phone ali seq * 3 - (2, 3 or 4) = # acoustic seq
