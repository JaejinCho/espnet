...
expname=${expname}_spkloss_weight${spkloss_weight}_fullyunsync_mem30G_ijson_memoryprofiling
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    CUDA_VISIBLE_DEVICES=${gpu_ix} fil-profile run ../../../espnet/bin/tts_train_speakerid_semi_multicorpora_ijson.py \
           --num-spk ${num_spk} \
