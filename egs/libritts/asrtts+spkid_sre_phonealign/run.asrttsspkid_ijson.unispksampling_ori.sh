...
# Copied from run.asrttsspkid_ijson.unispksampling.sh before the script adds
# compatibility between fully supervised and semi-supervised training by
# referring to run.asrttsspkid_ijson_sup.unispksampling.sh
...
expname=${expname}_spkloss_weight${spkloss_weight}_fullyunsync_mem${mem_request}_ijson
