...
# config files
train_config=conf/train_pytorch_tacotron2+spkemb_spkidonly_shufflebatching_specaug_bs128.yaml
...
expname=${expname}_speakeridonly_ttslossw${ttsloss_weight}_spkloss_weight${spkloss_weight}_final_unsync200to400random_specaugrate${specaug_rate}
