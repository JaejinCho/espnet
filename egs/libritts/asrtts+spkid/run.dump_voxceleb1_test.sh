...
# JJ: Edited from run.asrttsspkid.spkloss_weight.voxceleb1_filtered.sh
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    echo "stage 1: Normalize data/${eval_set}/feats.scp with data/${train_set}/cmvn.ark. Dumping to ${feat_ev_dir}"
