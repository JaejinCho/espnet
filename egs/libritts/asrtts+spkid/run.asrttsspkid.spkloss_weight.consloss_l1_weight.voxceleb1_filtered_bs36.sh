...
expname=${expname}_spkloss_weight${spkloss_weight}_consloss_l1_weight${consloss_weight}
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    ${cuda_cmd} --gpu ${ngpu} ${expdir}/train.log \
        tts_train_speakerid_consistency_l1.py \
           --model-module espnet.nets.pytorch_backend.e2e_tts_tacotron2_speakerid_consistency_l1:Tacotron2 \
           --num-spk ${num_spk} \
