...
expname=${expname}_speakeridonly_ttslossw${ttsloss_weight}_spkloss_weight${spkloss_weight}_final_unsync_chunklen${chunk_len}
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    ${cuda_cmd} --gpu ${ngpu} ${expdir}/train.log \
        tts_train_speakeridonly_temp.py \
           --model-module espnet.nets.pytorch_backend.e2e_tts_tacotron2_speakeridonly_temp_unsync_${chunk_len}:Tacotron2 \
           --num-spk ${num_spk} \
