...
data_list="sre19_eval_enroll_cmn2 sre19_eval_test_cmn2"
    ...
    (
        ...
        if [ ! -s data/${dataname}_NOdiscard/segments ]; then
            ...
            if [[ ${temp_nj} -le ${nj} ]]; then
                steps/segmentation/detect_speech_activity.sh --nj ${temp_nj} --extra-left-context 79 --extra-right-context 21 --extra-left-context-initial 0 --extra-right-context-final 0 --frames-per-chunk 150 --mfcc-config ${conf_dir}/SAD_related/vimal_SAD/conf/mfcc_hires.conf data/${dataname}_NOdiscard ${conf_dir}/SAD_related/vimal_SAD/exp/segmentation_1a/tdnn_stats_asr_sad_1a ${conf_dir}/SAD_related/vimal_SAD/sre20_train_prep_${dataname}_NOdiscard_mfcc ${conf_dir}/SAD_related/vimal_SAD/sre20_train_prep_${dataname}_NOdiscard_work data/${dataname}_NOdiscard
            else
                steps/segmentation/detect_speech_activity.sh --nj ${nj} --extra-left-context 79 --extra-right-context 21 --extra-left-context-initial 0 --extra-right-context-final 0 --frames-per-chunk 150 --mfcc-config ${conf_dir}/SAD_related/vimal_SAD/conf/mfcc_hires.conf data/${dataname}_NOdiscard ${conf_dir}/SAD_related/vimal_SAD/exp/segmentation_1a/tdnn_stats_asr_sad_1a ${conf_dir}/SAD_related/vimal_SAD/sre20_train_prep_${dataname}_NOdiscard_mfcc ${conf_dir}/SAD_related/vimal_SAD/sre20_train_prep_${dataname}_NOdiscard_work data/${dataname}_NOdiscard
            fi
