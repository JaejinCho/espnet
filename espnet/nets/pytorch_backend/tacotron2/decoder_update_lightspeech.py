...
class Decoder_light(torch.nn.Module):
    """Decoder_light module of Spectrogram prediction network.
    ...
    def __init__(self, idim, odim,
        ...
        # define lstm network
        # (JJ): From https://github.com/xcmyz/LightSpeech, dunits = 128
        if rnntype == 'lstm':
    ...
    def forward(self, hs, hlens, ys):
        ...
        hs = torch.stack(hs,dim=0) # convert from list to torch.tensor
