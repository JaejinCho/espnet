...
# Edited from ../../../espnet/bin/tts_train_speakerid_semi_multicorpora_ijson.py for supervised learning
...
def main(cmd_args):
    ...
    if args.backend == "pytorch":
        from espnet.tts.pytorch_backend.tts_speakerid_multicorpora_ijson import train
        train(args)
    else:
