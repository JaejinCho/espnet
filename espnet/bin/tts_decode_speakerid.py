...
def get_parser():
    ...
    # JJ added - start
    parser.add_argument('--spkid-onthefly', default=False, type=strtobool,
                        help='Whether to generate the speaker embedding on the fly.\
                        Currently only used in decode with a trained model with \
                        --train-spkid-extractor flag True in tts_train_speakerid.py')
    # JJ added - end
    return parser
