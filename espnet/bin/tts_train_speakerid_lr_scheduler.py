...
def get_parser():
    ...
    parser.add_argument('--lr-reduce-factor', default=0.33, type=float,
                        help='Reduce facotr when decreasing lr')
    parser.add_argument('--lr-reduce-patience', default=1, type=int,
                        help='Number of epochs to wait without improvement before reducing the lr')
...
def main(cmd_args):
    ...
    if args.backend == "pytorch":
        from espnet.tts.pytorch_backend.tts_speakerid_lr_scheduler import train
        train(args)
    else:
