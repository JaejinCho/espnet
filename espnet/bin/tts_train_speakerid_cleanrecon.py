...
# (JJ) Edited from ../../../espnet/bin/tts_train_speakerid.py
...
def get_parser():
    ...
    parser.add_argument('--update-opt', default=True, type=strtobool,
                        help='Whether to update optimizer config. when resuming from snapshot.ep.*')
...
def main(cmd_args):
    ...
    if args.backend == "pytorch":
        from espnet.tts.pytorch_backend.tts_speakerid_cleanrecon import train
        train(args)
    else:
