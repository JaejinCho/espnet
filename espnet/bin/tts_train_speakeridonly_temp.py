...
# JJ: Edited from ../../../espnet/bin/tts_train_speakeridonly_temp_ori.py to
# include moco. However, it is the same unless you set moco config. out of
# this script
...
def main(cmd_args):
    ...
    if args.backend == "pytorch":
        from espnet.tts.pytorch_backend.tts_speakeridonly_temp import train
        train(args)
    else:
