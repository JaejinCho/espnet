...
# Copied from bin/tts_train_speakerid_semi_multicorpora_ijson.py before the
# code integrates 1) the "clean reconstruction (cleanrecon)" function from
# bin/tts_train_speakerid_semi_multicorpora_ijson_cleanrecon.py, 2)
# "compatibility with fully supervised training" function by referring to
# bin/tts_train_speakerid_multicorpora_ijson.py
...
def get_parser():
    ...
    # task related
    parser.add_argument('--train-json-nolab', type=str, required=True,
...
def main(cmd_args):
    ...
    if args.backend == "pytorch":
        from espnet.tts.pytorch_backend.tts_speakerid_semi_multicorpora_ijson import train
        train(args)
    else:
