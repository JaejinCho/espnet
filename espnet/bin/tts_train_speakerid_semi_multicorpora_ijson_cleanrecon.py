...
# Edited from ../../../espnet/bin/tts_train_speakerid_semi_multicorpora_ijson.py
...
def main(cmd_args):
    ...
    if args.backend == "pytorch":
        from espnet.tts.pytorch_backend.tts_speakerid_semi_multicorpora_ijson_cleanrecon import train
        train(args)
    else:
