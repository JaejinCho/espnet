...
def get_parser():
    ...
    parser.add_argument('--consloss-weight', default=0, type=float,
                        help='Scaling hyperparmeter for consistency loss between reference speaker embedding and synthesized speaker embedding')
    # JJ added - end
...
def main(cmd_args):
    ...
    if args.backend == "pytorch":
        from espnet.tts.pytorch_backend.tts_speakerid import train
        train(args)
    else:
