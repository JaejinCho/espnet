# this is copied from
# /export/b18/jcho/espnet3/espnet/utils/io_utils_speakerid.py before it was
# replaced by
# /export/b18/jcho/espnet3/espnet/utils/io_utils_speakerid_cleanrecon.py
# For now, keep this in case the replaced one does not work as expected
